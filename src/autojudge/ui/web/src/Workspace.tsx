...
type Config = { name: string; objective: string; taxonomy: string; schema: string; examples: string; model: string; mode: string; budget: number; nodes: string[]; edges: string[][] };
