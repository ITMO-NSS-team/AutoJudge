...
if __name__ == "__main__":
    ...
    # )
    summaries_directory = Path("/Users/alina/Desktop/ITMO/AutoJudge/examples/who_and_when/step_summaries_gemini_2.5_flash/hand")
    ...
    for pool in all_pools:
        ...
        asyncio.run(
            main(
                save_folder=f"union_pool_gen_results_{cnt}",
                df=df_handcrafted,
